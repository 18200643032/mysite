...
class RecoverDone(SaltMixin, generic.TemplateView):
    template_name = 'password_reset/../../../AppData/Local/Programs/Python/Python38/Lib/site-packages/password_reset/templates/password_reset/reset_sent.html'
...
class Recover(SaltMixin, generic.FormView):
    ...
    template_name = 'password_reset/../../../AppData/Local/Programs/Python/Python38/Lib/site-packages/password_reset/templates/password_reset/recovery_form.html'
...
class Reset(SaltMixin, generic.FormView):
    ...
    token_expires = None
    template_name = 'password_reset/../../../AppData/Local/Programs/Python/Python38/Lib/site-packages/password_reset/templates/password_reset/reset.html'
...
class ResetDone(generic.TemplateView):
    template_name = 'password_reset/../../../AppData/Local/Programs/Python/Python38/Lib/site-packages/password_reset/templates/password_reset/recovery_done.html'
